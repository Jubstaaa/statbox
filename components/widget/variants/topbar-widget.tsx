...
export default function TopbarWidget({
    ...
    return (
        <div className="h-10 w-115 overflow-hidden rounded-xl border border-white/10 bg-[linear-gradient(90deg,rgba(0,0,0,0)_0%,rgba(8,20,28,0.72)_10%,rgba(8,20,28,0.82)_50%,rgba(8,20,28,0.72)_90%,rgba(0,0,0,0)_100%)] px-3 shadow-[0_12px_32px_rgba(0,0,0,0.2)] backdrop-blur-md">
            <div
